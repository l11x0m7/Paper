...
class SignalModModel(object):
    def __init__(self, config, log_path, model_path):
        ...
        cf.gpu_options.visible_device_list = '0,1'
...
if __name__ == '__main__':
    model = SignalModModel(Config(), '../log', '../model/model')
    model.fit(datapath='../data/train_mixSignals.txt', test_datapath='../data/test_mixSignals.txt')